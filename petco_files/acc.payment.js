ACC.payment={bindUseThisSavedCardButton:function()
...
{$(this).colorbox.resize();}});})},bindPaymentCardTypeSelect:function()
...
{ACC.payment.bindPaymentCardTypeSelect();ACC.payment.showSavedPayments();if(!typeof bindSecurityCodeWhatIs=='undefined')
