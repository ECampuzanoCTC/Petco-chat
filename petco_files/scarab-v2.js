var _scq = _scq || [];
_scq.push(['setMerchantId', '16EB3754BA3F6B5B']);
var _scdiscovery = _scdiscovery || {"visible":true,"config":{"alwaysShowAssistantbar":false,"desktopDisabled":false,"tabletDisabled":false,"mobileDisabled":true,"forceDiscoDrag":false,"textAlign":"left","disabledDefs":{"type":"urlDoesNotContain","patterns":["/checkout/orderConfirmation","radioshack.com.mx"]},"enableGoogleAnalytics":false,"staging":false,"lang":"es","currency":"MXN","background":"#0ea9e2","color":"#ff0033","font":"Arial, Helvetica, sans-serif","locales":{"desktop":{"es":{"productMore":"Ver Más","productDetails":"Ver Detalle"}}}}};
